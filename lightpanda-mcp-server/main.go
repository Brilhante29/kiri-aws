...
func main() {
	...
	// Buffer up to 10MB per input line
		...
		tools := []Tool{
			{
				...
				Description: "Fast web scraping & HTML extraction using Lightpanda ultra-low-memory headless browser.",
			...
			},
			{
				...
				Description: "Extracts clean Markdown text and AX Accessibility Tree from any web page via Lightpanda.",
				InputSchema: InputSchema{
					Type: "object",
					Properties: map[string]Property{
						"url": {Type: "string", Description: "Target URL to parse"},
					},
					Required: []string{"url"},
				},
			},
			{
				...
				InputSchema: InputSchema{
					...
					Properties: map[string]Property{
						...
						"script": {Type: "string", Description: "JavaScript code expression"},
					},
